function traerInformacion(){
    $.ajax({
        url:"https://g6ac6ff7009ff78-dbbicicleta.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/bike/bike",
        type:"GET",
        datatype:"JSON",
...
function borrarElemento(idElemento){
 ...
 function traerInformacionCliente(){
    $.ajax({
        url:"https://g6ac6ff7009ff78-dbbicicleta.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/client/client",
        type:"GET",
        datatype:"JSON",
...
function traerInformacionMensaje(){
    $.ajax({
        url:"https://g6ac6ff7009ff78-dbbicicleta.adb.sa-santiago-1.oraclecloudapps.com/ords/admin/message/message",
        type:"GET",
        datatype:"JSON",
